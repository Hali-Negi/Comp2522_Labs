...
document.getElementById("contact-btn")?.addEventListener("click", () => {
  ...
  const body = encodeURIComponent(
    "Hi! I’m interested in your Peer Support Finder project.\n\n"
  );
  const href = email
...
// Greeting
addMessage(
  "Hi! I’m your AI study partner for BCIT/SET. Ask about course tips, study partners, or campus resources."
);
